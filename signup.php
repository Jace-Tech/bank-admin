    ...
    <div class="relative flex">
      <div class="w-full md:w-1/2">
        <div class="min-h-screen h-full flex flex-col after:flex-1">
          <div class="flex-1">
            <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8"><a class="block" href="index.php"><svg width="32" height="32" viewBox="0 0 32 32">
                  <defs>
            ...
            <form action="./controllers/auth.controller.php" method="post">
              <div class="space-y-4">
                <div>
                  ...
                  <input required id="name" name="name" class="form-input w-full" />
                </div>

                <div>
                  <label class="block text-sm font-medium mb-1" for="email">Email Address <span class="text-red-500">*</span></label>
                  <input required id="email" class="form-input w-full" name="email" type="email" />
                </div>

                <div>
                  <label class="block text-sm font-medium mb-1" for="password">Password</label>
                  <input required id="password" class="form-input w-full" name="password" type="password" autocomplete="on" />
                </div>
