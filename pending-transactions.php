...
<?php $ALL_TRANSACTIONS = getAllPendingTransactions($TOKEN); ?>
...
<head>
  <meta charset="utf-8">
  <title>Dashboard - Pending Transactions</title>
        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
              <h1 class="text-2xl md:text-3xl text-gray-800 font-bold">Pending Transactions</h1>
            </div>
                          ...
                          <td class="p-3">
                            <div class="flex gap-2">
                             ...
                             <?php include("./components/transactionApprove.php") ?>
                              ...
                              <!-- CANCEL PART -->
                              <?php include("./components/transactionCancel.php") ?>
                              <!-- CANCEL PART -->
                            </div>
                          </td>
                          <td></td>
