    ...
    <div class="relative flex">
      <div class="w-full md:w-1/2">
        <div class="min-h-screen h-full flex flex-col after:flex-1">
          <div class="flex-1">
            <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8"><a class="block" href="index.php">
          ...
          <div class="max-w-sm mx-auto px-4 py-8" style="min-width: 364px;">
            ...
            <form action="./controllers/auth.controller.php" method="post">
              <div class="space-y-4">
                <div>
                  ...
                  <input required id="email" name="email" class="form-input w-full" type="email" />
                </div>
                <div><label class="block text-sm font-medium mb-1" for="password">Password</label>
                  <input required id="password" name="password" class="form-input w-full" type="password" autocomplete="on" />
                </div>
              </div>
              <div class="flex items-center justify-between mt-6">
                ...
                <button name="login" class="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3">Sign In</button>
              </div>
            </form>
            <div class="pt-5 mt-6 border-t border-gray-200">
              <div class="text-sm">Don’t you have an account? <a class="font-medium text-indigo-500 hover:text-indigo-600" href="signup">Sign Up</a></div>
            </div>
          </div>
        </div>
      </div>
