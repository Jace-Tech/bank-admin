            ...
            <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0  bg-gray-900" x-data="{ open: false }">
              ...
              <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                <ul class="pl-9 mt-4" :class="!open && 'hidden'" x-cloak>
                  ...
                  <li class="mb-3"><a class="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" href="generate-transaction"><span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Generate Transaction</span></a>
                  </li>
                </ul>
              </div>
            </li>
